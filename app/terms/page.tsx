...
export const metadata: Metadata = {
  title: "服務條款",
  description: "使用錢途平台前，請詳細閱讀本服務條款。",
};
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <div className="mt-8 space-y-8 text-[16px] leading-[1.85] text-ink/90">
        <p>
          歡迎使用錢途！請在使用本平台前詳細閱讀以下服務條款。使用錢途即表示您同意本服務條款的所有內容。
        </p>
        ...
        <section aria-labelledby="t-1">
          ...
          <p className="mt-3">
            錢途是一個免費的理財教育平台，專為台灣高中生設計。平台內容包含文章課程、互動測驗與情境模擬，用途為財金知識教育，幫助使用者練習理財決策。
          </p>
        </section>
        ...
        <section aria-labelledby="t-2">
          ...
          <p className="mt-3">
            錢途平台上的所有內容、數字、情境與模擬結果，僅供教學用途，不構成、也不應被視為個人化的投資建議、財務規劃建議或任何形式的專業意見。平台內的「歷史回放投資模擬」功能使用真實歷史市場資料進行教學情境練習，但模擬結果不代表也不保證未來實際投資表現。做任何真實的財務或投資決定前，請諮詢合格的專業人士。
          </p>
        </section>
        ...
        <section aria-labelledby="t-3">
          ...
          <p className="mt-3">
            錢途主要設計給台灣高中階段的學生使用。若您未滿 13 歲，建議您在家長或監護人的同意與陪同下使用本平台。
          </p>
        </section>
        ...
        <section aria-labelledby="t-4">
          ...
          <p className="mt-3">
            錢途使用系統自動產生的六碼代碼作為識別方式，不需要註冊真實身分資訊。您有責任妥善保管您的代碼；如代碼遺失，您可能無法復原先前的學習進度。請勿嘗試取得或使用非您本人的代碼。
          </p>
        </section>
        ...
        <section aria-labelledby="t-5">
          ...
          <p className="mt-3">使用錢途時，您同意不會：</p>
        ...
        <section aria-labelledby="t-6">
          ...
          <p className="mt-3">
            錢途平台上的所有內容（包含文章、圖像、程式碼、設計）皆為錢途團隊或其授權來源所有，受著作權法保護。未經授權，請勿重製、散布或用於商業用途。
          </p>
        </section>
        ...
        <section aria-labelledby="t-8">
          ...
          <p className="mt-3">
            錢途是由學生團隊開發、免費提供的教育平台，依「現況」提供，不保證內容完全無誤或服務不會中斷。在法律允許的最大範圍內，錢途團隊不對因使用（或無法使用）本平台所產生的任何直接或間接損失負責。
          </p>
        </section>
        ...
        <section aria-labelledby="t-10">
          ...
          <p className="mt-3">
            我們可能會不時更新本服務條款。重大修改時，我們會在平台上公告。持續使用錢途即表示您同意經修改後的條款。
          </p>
        </section>
