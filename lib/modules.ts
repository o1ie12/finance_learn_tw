...
export const MODULES: ModuleMeta[] = [
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          ...
          "個人買賣股票的價差目前不課所得稅；但每次「賣出」都自動課證交稅——股票 0.3%（當沖降為 0.15%）、ETF 0.1%，不論賺賠",
          "買股票的當下要先預繳一筆獲利稅",
        ],
        answer: 1,
        explain:
          "台灣個人證券交易所得目前停徵（不課），改在「賣出」時按成交金額課證交稅：股票 0.3%（當沖 0.15%）、ETF 0.1%，賺賠都要繳。這是全課程最「這裡不是美國」的一段。",
      },
      {
        id: "m5q3",
        q: "你賣出 NT$100,000 的 0050（ETF，非當沖），這一筆會自動被收多少證券交易稅？",
        options: [
          "NT$300（= 100,000 × 0.3%），跟賣股票一樣",
          "要看賺多少，賺越多收越多",
          "NT$100（= 100,000 × 0.1%），ETF 的稅率比股票低，不論這筆是賺是賠",
        ],
        answer: 2,
        explain:
          "證交稅按「成交金額」課，和賺賠無關；但稅率看你賣的是什麼——0050 是 ETF，適用 0.1%，所以是 NT$100。賣股票才是 0.3%。",
      },
    ],
  },
  ...
  },
  {
    ...
    quiz: [
      {
        id: "m39q1",
        q: "為什麼先想「興趣」再想「收入」比較有用？",
        options: [
          "因為興趣可以直接換成錢",
          "因為職涯是長期的事，做得下去才談得上累積",
          "因為收入不重要",
        ],
        answer: 1,
        explain:
          "收入會隨年資和能力變動，但能不能持續做下去，往往決定你有沒有機會走到收入變好的那一段。",
      },
      {
        id: "m39q2",
        q: "「這條路收入比較低，所以比較差」這句話的問題在哪？",
        options: [
          "沒有問題，收入就是唯一標準",
          "它只看起薪，忽略了成長幅度、穩定度與準備期等其他差異",
          "收入其實都一樣",
        ],
        answer: 1,
        explain:
          "不同路徑的差別是「形狀」不同——起步快慢、成長陡緩、穩不穩定，不是單一一條線比較高或比較低。",
      },
      {
        id: "m39q3",
        q: "高中階段就選定一個方向，比較合理的心態是？",
        options: [
          "選了就不能改，要一次選對",
          "先有個方向可以開始累積，之後仍然可以調整",
          "不用想，反正以後再說",
        ],
        answer: 1,
        explain:
          "方向是用來開始累積的，不是用來綁死自己的。多數人的職涯都會轉幾次彎。",
      },
    ],
  },
  {
    ...
    station: "職涯站",
    title: "不同路徑，不同形狀",
    enTitle: "Different Paths, Different Shapes",
    ...
    quiz: [
      {
        ...
        answer: 0,
        explain:
          "有些路徑需要先念書、考照或當學徒，那段時間收入很低甚至沒有——這是選擇的一部分成本。",
      },
      {
        id: "m40q2",
        q: "一條準備期長、但後面成長快的路徑，最大的風險是什麼？",
        options: [
          "完全沒有風險",
          "前期要撐得過去，包含生活費和心理上的等待",
          "後面收入一定會很低",
        ],
        answer: 1,
        explain:
          "成長快的前提是你走得到那一段。準備期越長，前期的支撐（存款、家庭、打工）就越關鍵。",
      },
      {
        id: "m40q3",
        q: "比較兩條職涯路徑時，只看「起薪」為什麼不夠？",
        options: [
          "起薪其實不重要",
          "因為成長幅度、穩定度與準備期都會影響長期結果",
          "因為起薪都是假的",
        ],
        answer: 1,
        explain:
          "起薪只是曲線的起點。五年、十年後的位置，取決於這條線往上爬的速度和穩不穩。",
      },
    ],
  },
  {
    ...
    station: "決策站",
    title: "買房 vs 租屋：三個關卡",
    enTitle: "Buy or Rent: Three Gates",
    subtitle: "頭期款、月付、銀行點不點頭——卡住的關卡不同，該準備的也不同。",
    minutes: 6,
    tier: "core",
    ...
    quiz: [
      {
        id: "m41q1",
        q: "銀行通常最多借房價的幾成？",
        options: ["全部", "約八成", "約五成", "看心情"],
        answer: 1,
        explain:
          "常見上限是八成，剩下的兩成要自己準備，也就是頭期款。所以頭期款卡的是存款，不是收入。",
      },
      {
        id: "m41q2",
        q: "「付得出頭期款」等於「買得起」嗎？",
        ...
        answer: 1,
        explain:
          "頭期款只是入場券。真正要撐三十年的是月付，以及月付之後剩下的生活費。",
      },
      {
        id: "m41q3",
        q: "為什麼房貸利率跟幾年前的繳款習慣有關？",
        options: [
          "沒有關係，利率是隨機的",
          "銀行用信用記錄判斷放款風險，記錄會影響利率甚至核准與否",
          "只有公務員才有差",
          "只跟年齡有關",
        ],
        answer: 1,
        explain:
          "信用記錄是長期累積的，不是申請當天才決定。利率差零點幾個百分點，乘上三十年就不是小數字。",
      },
    ],
  },
];
